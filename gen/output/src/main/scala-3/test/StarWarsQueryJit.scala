...
object StarWarsQueryJit extends GraphQLOperation[StarWars] {
  ...
  object Data {
    ...
    extension (thiz: Data) @scala.annotation.targetName("Data_characterAttempt") def characterAttempt: Either[Throwable, Option[Data.Character]] = _root_.io.circe.Decoder[Option[Data.Character]].decodeJson(thiz.asInstanceOf[_root_.io.circe.Json].asObject.get.apply("character").get)
    ...
    object Character {
      ...
      object Friends {
        ...
        extension (thiz: Friends) @scala.annotation.targetName("Friends_nameAttempt") def nameAttempt: Either[Throwable, Option[String]] = _root_.io.circe.Decoder[Option[String]].decodeJson(thiz.asInstanceOf[_root_.io.circe.Json].asObject.get.apply("name").get)
      ...
      object Human {
        ...
        extension (thiz: Human) @scala.annotation.targetName("Human_idAttempt") def idAttempt: Either[Throwable, String] = _root_.io.circe.Decoder[String].decodeJson(thiz.asInstanceOf[_root_.io.circe.Json].asObject.get.apply("id").get)
        extension (thiz: Human) @scala.annotation.targetName("Human_name") def name: Option[String] = thiz.nameAttempt.toTry.get
        extension (thiz: Human) @scala.annotation.targetName("Human_nameAttempt") def nameAttempt: Either[Throwable, Option[String]] = _root_.io.circe.Decoder[Option[String]].decodeJson(thiz.asInstanceOf[_root_.io.circe.Json].asObject.get.apply("name").get)
        ...
        extension (thiz: Human) @scala.annotation.targetName("Human_homePlanetAttempt") def homePlanetAttempt: Either[Throwable, Option[String]] = _root_.io.circe.Decoder[Option[String]].decodeJson(thiz.asInstanceOf[_root_.io.circe.Json].asObject.get.apply("homePlanet").get)
        ...
        extension (thiz: Human) @scala.annotation.targetName("Human_friendsAttempt") def friendsAttempt: Either[Throwable, Option[List[Data.Character.Friends]]] = _root_.io.circe.Decoder[Option[List[Data.Character.Friends]]].decodeJson(thiz.asInstanceOf[_root_.io.circe.Json].asObject.get.apply("friends").get)
      ...
      object Droid {
        ...
        extension (thiz: Droid) @scala.annotation.targetName("Droid_idAttempt") def idAttempt: Either[Throwable, String] = _root_.io.circe.Decoder[String].decodeJson(thiz.asInstanceOf[_root_.io.circe.Json].asObject.get.apply("id").get)
        extension (thiz: Droid) @scala.annotation.targetName("Droid_name") def name: Option[String] = thiz.nameAttempt.toTry.get
        extension (thiz: Droid) @scala.annotation.targetName("Droid_nameAttempt") def nameAttempt: Either[Throwable, Option[String]] = _root_.io.circe.Decoder[Option[String]].decodeJson(thiz.asInstanceOf[_root_.io.circe.Json].asObject.get.apply("name").get)
        ...
        extension (thiz: Droid) @scala.annotation.targetName("Droid_friendsAttempt") def friendsAttempt: Either[Throwable, Option[List[Data.Character.Friends]]] = _root_.io.circe.Decoder[Option[List[Data.Character.Friends]]].decodeJson(thiz.asInstanceOf[_root_.io.circe.Json].asObject.get.apply("friends").get)
        ...
        extension (thiz: Droid) @scala.annotation.targetName("Droid_primaryFunctionAttempt") def primaryFunctionAttempt: Either[Throwable, Option[String]] = _root_.io.circe.Decoder[Option[String]].decodeJson(thiz.asInstanceOf[_root_.io.circe.Json].asObject.get.apply("primaryFunction").get)
